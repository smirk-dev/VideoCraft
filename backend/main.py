...
def analyze_video(filename=None):
    """Analyze uploaded video and return insights - supports multiple endpoint formats"""
    try:
        # Get request data
        data = request.get_json() or {}
        logger.info(f"Analysis request to {request.path}: {data}")
        
        # Simulated analysis results matching frontend expectations
        analysis_result = {
            "success": True,
            "analysis": {
                "emotion_detection": {
